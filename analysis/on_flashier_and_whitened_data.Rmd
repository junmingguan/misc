...
We see here that the fit (either with $\sigma^2$ fixed or estimated) is essentially 0, and $\lambda$ converges to 0, although initially it is larger than $p=10$ ($1+K=10$). Also, the estimated prior variance for $z$ converges to 0.
