...
- For extracting non-Gaussian sources, the whitening step seems to matter more than the G_2 term in the FastICA update.
...
- Fitting a higher-rank model may help recover one true source when the true rank is high, since it gives the algorithm more flexibility to separate the target source from the remaining structured variation.
